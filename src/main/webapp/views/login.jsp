...
<body>
  <%-- Hiển thị thông báo đăng ký thành công nếu tham số registerSuccess=true --%>
    <c:if test="${param.registerSuccess eq 'true'}">
        <div style="color: green;">Registration successful! You can now login.</div>
    </c:if>
...
<div class="col-8 offset-2 mt-4">
    <div class="card-body">
        ...
        <form action="<c:url value='/login'/>" method="POST">
            ...
            <div class="form-group">
                <button tabindex="3" type="submit" class="btn btn-danger btn-block">Login</button>
            </div>
            <br>
            <div class="input-group mb-3">
                <button class="btn btn-lg btn-light w-100 fs-6">
                    <img src="images/googlelogin.png" style="width: 25px;" class="me-2">Sign in with google
                </button>
            </div>
        </form>
