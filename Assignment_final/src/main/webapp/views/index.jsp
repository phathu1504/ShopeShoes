        ...
        <div class="navbar">
            <div class="container-fluid">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href=<c:url value='/index' />>
                            <span style="color: red; font-size:medium;" class="fas fa-home active"> <fmt:message key="menu.home"/></span>
                        </a>
                    </li>
                    <li class="nav-item dropdown" style="margin-left: 10px; margin-top: 5px">
                        <a class="nav-link dropdown-toggle 	fas fa-user-alt" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false" style="color: red"><fmt:message key="menu.acc" /> </a>
                        <ul class="dropdown-menu">
    <c:choose>
        <c:when test="${empty sessionScope.user}">
            <li><a href="<c:url value='/login' />" style="color: red"><fmt:message key="menu.login" /></a></li>
            <li><a href="<c:url value='/register' />" style="color: red"><fmt:message key="menu.sign" /></a></li>
        </c:when>
        <c:otherwise>
            ...
            <li><i>Welcome,</i> <b>${sessionScope.user.username}</b></li>
                    ...
                    <li class="nav-item" style="margin-left: 10px;">
                        <a class="nav-link" href="#!giohang" >
                            <li ><a href="<c:url value='/cart?action=view' />">  <span style="color: red; font-size:medium; margin-top: 13px" class="fas fa-home"> <fmt:message key="menu.cart" /></span> <b style="color: red" >(<span id="countTotal">${sessionScope.cart.tongsl}</span>)</b></a></li>
                        </a>
                    </li>
                 <!-- Language Selection -->
<div class="languageTop">
    <ul>
        <li><a href="?lang=vi"><img src="images/flag-vn.png" alt="VN"></a></li>
        <li><a href="?lang=en"><img src="images/flag-en.png" alt="EN"></a></li>
    </ul>
</div>
...
<div class="dropdown" style="margin-left: 44%">
  ...
  <ul class="dropdown-menu">
    ...
    <c:forEach var="category" items="${listCategory}">
        <li><a style="color: red;" href="<c:url value='/sanpham?maDM=${category.madm}'/>">${category.tendanhmuc}</a></li>
    </c:forEach>
</li>
                ...
                <div class="col-md-4" style="margin-top: 20px;">
                    <div class="card">
                        <div class="card-body text-center">
                            <a href="<c:url value='/sanpham?maSP=${product.masp}' />"><img  width="100%" height="200px" alt="" src="<c:url value='images/${product.hinh}' />"></a><br/>
                        </div>
                        <div class="card-header text-center">
                            <p><a href="<c:url value='/sanpham?maSP=${product.masp}' />" class="title">${product.tensp}</a><br/></p>
                        </div>
                        <div class="card-footer text-center">
                            ...
                            <ul>
                                <li>--Mô tả--</li>
                                <span class="category">${product.mota}></span>
                                 
                            </ul>
                        </div>
    <button class="btn btn-outline-danger" type="button">  <a href="DetailsServlet?vid=${product.masp}">
    Mua</a>
    </button>
                    </div>
                </div>
